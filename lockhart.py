...
BOT_STAGGER_SLOTS = {
    ...
    "RHYTHM": 5, "SYMPHONY": 6, "TUNESTREAM": 7, "ALUCARD": 8, "SAPPHIRE": 9, "STRIFE": 10, "LOCKHART": 11,
}
...
async def snapshot_queue_backup(cur, guild_id):
    ...
    if insert_data:
        await cur.executemany(
            "INSERT INTO lockhart_queue_backup (guild_id, bot_name, video_url, title, requester_id, track_uid) VALUES (%s, %s, %s, %s, %s, %s)",
            insert_data,
        )
